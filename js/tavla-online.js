...
(function () {
  ...
  // Sekme/pencere bazlı parça: room-waiting-fix.js / chess-online.js /
  // okey-online.js ile AYNI mantık. Aynı profildeki farklı pencereler ayrı
  // koltuk alır; F5 (sessionStorage) reconnect eşleşmesini korur.
  function tabKey() {
    try {
