...
(function () {
  ...
  load('js/lobby-sync.js?v=20260820b', 'data-gv-lobby-sync');
  load('js/room-waiting-fix.js?v=20260820b', 'data-gv-room-fix');
  ...
  window.__gvEnsureChessOnline = function () {
    ...
    load('js/chess-online.js?v=20260820b', 'data-gv-chess-online');
  };
  ...
  window.__gvEnsureOkeyOnline = function () {
    ...
    load('js/okey-online.js?v=20260820b', 'data-gv-okey-online');
  };
