<?php
/* GameVerse — Yöncü tarafı yapılandırması (sunucuya özel — GitHub'a KONMAZ) */

define('GV_DB_HOST', 'localhost');
define('GV_DB_NAME', 'masaoyun_db');
define('GV_DB_USER', 'masaoyun_kurucu');
define('GV_DB_PASS', 'kurucu123');   // ← oPanel'de belirlediğin şifre

define('GV_SERVER_KEY', 'xK9$mQ2vLp#7nB4wR8zT3yU6eF1aS5dG0hJ');
